...
const getCircadianProperties = (hour) => {
  // Morning
  let lightColor = 'rgba(255, 223, 186, 0.7)'; 
  ...
  if (hour >= 11 && hour < 17) {
    ...
    lightPhaseDescription = "Evening/Night Light: Very warm, low intensity light to promote relaxation.";
...
// Renders the rotating mandala on a canvas
...
const LampScene = () => {
  ...
  const effectiveHour = useRealTime ? realTime.getHours() : manualHour;
